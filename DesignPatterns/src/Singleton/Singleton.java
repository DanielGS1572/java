...
public class Singleton {
	...
	private static Singleton firstInstance = null;  //este será el access point, por lo tanto debe ser estatico
	...
	private Singleton() { }		// El constructor se define como privado para encapsularlo y controlar que solo exista una sola instancia
	...
	public static /*synchronized hace que todo se haga mas lento por loq ue por eso se pone synchronized(Singleton.class)*/Singleton getInstance() {

...
import com.example.tienda3.datos.HelperClassAltaCombos;
import com.example.tienda3.datos.HelperClassAltaProductos;
import com.example.tienda3.datos.HelperClassAltaPromociones;
import com.example.tienda3.datos.HelperClassCatalogoProductos;
...
public class ComprasClientes extends UI {
	...
	@WebServlet(value = { "/comprascliente/*", "/VAADIN/*" }, asyncSupported = true)
